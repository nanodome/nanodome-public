...
#ifndef LINKED_LANGEVIN_SIMULATON_H
#define LINKED_LANGEVIN_SIMULATON_H
...
class LinkedLangevinSimulation :public LinkedSimulation {
...
public:
	...
	LinkedLangevinSimulation(raw_configuration_data _xml_data);
