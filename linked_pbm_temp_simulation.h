...
#ifndef PBM_LINKED_TEMP_SIMULATION
#define PBM_LINKED_TEMP_SIMULATION
...
class PBMLinkedTempSimulation :public LinkedSimulation {
...
public:
	...
	PBMLinkedTempSimulation(raw_configuration_data _xml_data);
